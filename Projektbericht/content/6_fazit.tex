...
Ein Beispiel für einen anderen passenden Kontext wäre, eine Augmented Reality Applikation für eine \textquote{Schnitzeljagd} durch die Räumlichkeiten der Hochschule, bei der beispielsweise erkennbare Marker auf Büros, das Bild von dem jeweiligen Professor anzeigen und die Nutzer Fragen gestellt bekommen.
...
Änderungen in den Szenen sind in einem Merge-Tool außerhalb von Unity schwer nachzuverfolgen, da die als \textquote{.unity}-Datei gespeicherten Szenen nicht gelesen werden können. 
