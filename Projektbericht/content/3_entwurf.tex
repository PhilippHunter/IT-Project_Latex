...
Android Studio ist vermutlich das erste woran man denkt, wenn man an die Entwicklung einer Applikation für das Android Betriebssystem rangeht. Die Umgebung ist speziell für die klassische mobile Appentwicklung prädestiniert und soll den Entwickler dabei unterstützen, eine native Adroid-Applikation zu erstellen. Grundsätzlich bietet Android Studio auch einige Schnittstellen zu Augmented-Reality-Frameworks wie beispielsweise \textit{ARCore} an. Da die meisten Teammitglieder wenig bis keine Erfahrung mit der Umgebung haben, wäre es zudem ein aufschlussreiches Erlebnis, diese IDE näher kennenzulernen.
