...
\begin{figure}[!htb]
\minipage{0.48\textwidth}
  \includegraphics[width=\linewidth]{Hauptmenu.jpg}
  \caption{Hauptmenü}\label{fig:Hauptmenu}
\endminipage\hfill
\minipage{0.48\textwidth}
  \includegraphics[width=\linewidth]{Kontinente.jpg}
...
\begin{figure}[!htb]
\minipage{0.48\textwidth}
  \includegraphics[width=\linewidth]{Laender.jpg}
  \caption{Übersicht der Länder in einem Kontinent}\label{fig:Laender}
\endminipage\hfill
\minipage{0.48\textwidth}
  \includegraphics[width=\linewidth]{Laenderstart.jpg}
...
\begin{figure}[!htb]
\minipage{0.48\textwidth}
  \includegraphics[width=\linewidth]{Informationen.jpg}
  \caption{Informationen zu einem Land}\label{fig:Informationen}
\endminipage\hfill
\minipage{0.48\textwidth}
  \includegraphics[width=\linewidth]{AR.jpg}
...
\endminipage\hfill
\minipage{0.48\textwidth}
  \includegraphics[width=\linewidth]{Quiz_bestanden.jpg}
...
\begin{figure}[!htb]
\minipage{0.48\textwidth}
  \includegraphics[width=\linewidth]{Quiz_nichtBestanden.jpg}
